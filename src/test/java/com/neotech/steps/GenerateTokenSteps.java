...
public class GenerateTokenSteps {
	...
	public void i_provide_the_request_body_to_generate_token() {
		...
		// The payload is from "Request body" on the documentation.
		String payload = "{\n"
	...
	@Given("I set the headers information for token requet")
	public void i_set_the_headers_information_for_token_requet() {
